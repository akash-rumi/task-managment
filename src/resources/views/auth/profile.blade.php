                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-4 text-center">
                            <img src="{{ $user->avatar_url ?? 'https://via.placeholder.com/150' }}" alt="PROFILE" class="img-fluid rounded mb-2">
                        </div>
                        <div class="col-sm-8">
                            <h4 class="mb-1">{{ $user->name }}</h4>
                            <p class="mb-1"><strong>Email:</strong> {{ $user->email ?? 'N/A' }}</p>
                            <p class="mb-1"><strong>Role:</strong> {{ $user->isAdmin() ? 'Admin' : 'Regular' }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-4">
            @if($user->employee)
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="col-sm-8">
                            <p class="mb-1"><strong>Position:</strong> {{ $user->employee->designation ?? 'N/A' }}</p>
                            <p class="mb-1"><strong>Phone:</strong> {{ $user->employee->phone ?? 'N/A' }}</p>
                            <p class="mb-0"><strong>Joined:</strong> {{ $user->employee->created_at->format('Y-m-d') ?? '—' }}</p>
                        </div>
                    </div>
                </div>
            @endif
